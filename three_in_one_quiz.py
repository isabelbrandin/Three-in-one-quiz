...
while again == 'yes':
    ...
    if score > len(questions)/2:
        print('Congratulations! \nYou got', str(score), 'out of', len(questions), 'It means that you got ', str(score / len(questions) * 100), '%', ' of all user_choice correct! \n')
    else:
        print('You got', str(score), 'out of', len(questions), 'answers correct.. ', '\nIt means that you only got ', str(score / len(questions) * 100), '%', 'of all user_choice correct.. \nI am sorry, better luck next time! \n')
